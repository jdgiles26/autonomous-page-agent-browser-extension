...
export interface AgentConfig extends LLMConfig {
	...
	/**
	 * Callback for recording demo steps.
	 * Called after each tool execution when demo mode is enabled.
	 * @experimental
	 * @param toolName - Name of the tool that was executed
	 * @param input - Input parameters for the tool
	 * @param output - Output/result from the tool execution
	 */
	onDemoStep?: (toolName: string, input: Record<string, unknown>, output: string) => void
}
